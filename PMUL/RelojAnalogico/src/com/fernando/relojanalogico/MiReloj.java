 ...
 */
@RemoteView
public class MiReloj extends View {
    ...
    public MiReloj(Context context) {
        this(context, null);
    }

    public MiReloj(Context context, AttributeSet attrs) {
    ...
    public MiReloj(Context context, AttributeSet attrs,
        ...
        TypedArray a =
                context.obtainStyledAttributes(
                        attrs, R.styleable.MiReloj, defStyle, 0);

        mDial = a.getDrawable(R.styleable.MiReloj_reloj);
        if (mDial == null) {
...
//    }
    protected float getMinute() {
    	return this.mMinutes;
    }
    
    protected void setTime(float min) {
    	this.mMinutes = min;
    }
}